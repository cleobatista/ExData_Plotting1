...
par(mfrow=c(2,2))  
plot(x$Global_active_power~x$Date_Time,type="l",ylab="Global Active Power", xlab="")
plot(x$Voltage~x$Date_Time,type="l",ylab="Voltage", xlab="datetime")
...
plot(x$Global_reactive_power~x$Date_Time,type="l",ylab="Global_reactive_power", xlab="datetime")
dev.off()
